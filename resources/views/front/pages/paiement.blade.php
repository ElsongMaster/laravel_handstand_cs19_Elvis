...
<body class="d-flex">
    ...
    <div class="datails-payement">
        <h5 class="summary">Summary</h5>
        <div class="promo">
            <p>Do you have a promo code</p>
        </div>
        <div class="subtotal">
            <p><span>subtotal</span> <span>$prix</span></p>
        </div>
        <div class="subtotal-tax">
            <p><span class="tax">Tax</span></p>
        </div>
        <div class="total">
            <p><span>total</span><span>$tot</span></p>
        </div>
        <div class="checkout">
            <a href="" class="btn btn-warning">checkout</a>
            <a href="http://">Check out with <span>Paypal</span></a>
        </div>
    </div> --}}
