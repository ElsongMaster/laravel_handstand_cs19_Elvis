...
@endif
 ...
 <h1 class="text-center my-3"> Create Data package</h1>
...
<form action="{{route('packages.store')}}" method="post"   enctype="multipart/form-data" >
    ...
    <div class="mb-3">
        ...
        <input type="text" value="{{old('prix')}}"   class="form-control" id="prix" name="prix" >
    </div>
    <div class="mb-3">
        <label for="frequence" class="form-label">frequence</label>
        <input type="text"  value="{{old('frequence')}}"  class="form-control" id="frequence" name="frequence" >
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input type="text" value="{{old('li4')}}"  class="form-control" id="li4" name="li4" >
    </div>
